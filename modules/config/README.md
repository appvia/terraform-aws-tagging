...
| <a name="input_config_resource_types"></a> [config\_resource\_types](#input\_config\_resource\_types) | List of AWS resource types to evaluate | `list(string)` | <pre>[<br/>  "AWS::*"<br/>]</pre> | no |
